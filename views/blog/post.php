...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'py-12' ); ?>>

	<article class="space-y-2 xl:grid xl:grid-cols-5 xl:space-y-0 xl:items-baseline">

		<dl><dt class="sr-only"><?php esc_html_e( 'Published on', 'flex' ); ?></dt>

			<dd class="text-sm font-medium text-gray-500 lg:text-base">

				<time datetime="2021-06-17T14:00:00.000Z"><?php echo esc_html( $view_params['post_date'] ); ?></time>
		...
		<div class="space-y-5 xl:col-span-4">
			...
			<?php if ( has_post_thumbnail() ) : ?>
				...
				<div class="overflow-hidden  h-80 post-image">
			...
			<div class="space-y-6">
				...
				<h2 class="text-2xl font-bold tracking-tight ">
					...
					<a class="flex items-center text-gray-900 truncate" href="<?php echo esc_url( $view_params['post_link'] ); ?>">
				...
				<div class="overflow-hidden leading-[1.75rem] text-gray-500 max-w-none overflow-ellipsis">
			...
			<div class="text-base font-medium">
				<a class="text-blue-600 transition duration-300 ease-out hover:text-blue-500" href="<?php echo esc_url( $view_params['post_link'] ); ?>"><?php esc_html_e( 'Read more →', 'flex' ); ?></a></div>
